...
public class Calc1 extends JFrame {
	...
	int flag=0; // flag used to switch from number to function and to stop or =
	final Timer timer; //global timer 
	int button_eq_check=0;
	int check_on_func=0;
	int check_on_no=0;
	// global buttons
	...
	public Calc1() {
		...
		setBounds(100, 100, 267, 356);
		contentPane = new JPanel();
		contentPane.setBorder(new EmptyBorder(5, 5, 5, 5));
		setContentPane(contentPane);
		contentPane.setLayout(null);
		timer = new Timer(1000, new TimerListenerNum());
		 ...
		 // used to manage highlighting from one number or function to next one
	      ...
	      if(flag==0 || flag==2){
	    	  if(row==10){
	    	   ...
	    	   // highlighting 0 then 1 then 2 and so on up to 9
               if(row==0){
            	   button_9.setBackground(null);	// change previous highlighted button to null color	            	   
	    	  ...
	    	  else if (flag==1){   // highlighting functions
	    		  if(row==4){
		    		  row=0;	    		  
		    	  }   
		    	  if(row==0){
	           	   button_div.setBackground(null);		            	  
	           	   button_plus.setBackground(Color.RED);
		              ...
		              //activate on enter button click
		           	   ...
		           	   button_sub.setBackground(null);		            	  
		           	   button_mult.setBackground(Color.RED);		            	  
		               ...
		               //activate on enter button click
		           	   ...
		           	   button_mult.setBackground(null);		            	  
		           	   button_div.setBackground(Color.RED);		            	  
	            	   ...
	            	   button_0.getActionMap().put("actionName", new AbstractAction("actionName") {            		
						private static final long serialVersionUID = 1L;
							...
							public void actionPerformed(ActionEvent evt) {
								if(button_eq_check==0 && check_on_func==1 && check_on_no==1){
								    check_on_func=0;
									button_eq.setBackground(null);
									button_eq_check++;
									flag++;
									row=0;
									String answer;
